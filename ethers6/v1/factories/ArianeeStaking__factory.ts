...
export class ArianeeStaking__factory {
  static readonly abi = _abi;
  static createInterface(): ArianeeStakingInterface {
    return new Interface(_abi) as ArianeeStakingInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ArianeeStaking {
    return new Contract(address, _abi, runner) as unknown as ArianeeStaking;
  }
}
